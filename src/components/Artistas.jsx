      ...
      <>
        {artistas.map((artista, index)=>(
          <Link to={`artista/albuns/${artista.id}`} key={index}>
            <div className="gap-5 flex w-100 p-5 shadow-2xl border-2 border-neutral-700 m-5 bg-gradient-to-tl hover:bg-gradient-to-tr hover:from-neutral-900 hover:to-neutral-950 cursor-pointer from-neutral-800 to-neutral-900 items-center">
