        ...
        <ModalBody>
          <div className="text-white flex flex-col items-center">
            ...
            <div className="w-full flex flex-col items-center">
              ...
              <div ref={divRef} className={`p-40 border-4 border-slate-800 items-center gap-2`}>
                
                <div className="w-full flex flex-col items-center">
                  <p className="text-7xl font-bold mb-10 w-full">MelodyMingler</p>
                  <img className="w-[45rem] border-8 border-slate-700 rounded-xl" src={review.InfoAlbum.images[0].url}/>
                  <p className="w-full font-semibold text-7xl text-center">{review.nameAlbum}</p>
                  <p className="w-full text-4xl">by: {review.InfoAlbum.artists[0].name}</p>
                  ...
                  <p className="text-justify w-full mt-2 text-4xl font-thin">{review.avaliacao}</p>
                </div>
