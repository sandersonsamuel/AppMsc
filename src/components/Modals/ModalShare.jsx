  ...
  return (
    <>
      ...
      <i
        ...
        className="fa-solid fa-up-right-from-square hover:scale-[1.15]"
      ></i>
        ...
        <ModalBody>
          <div className="text-white flex flex-col items-center">
            <div className="text-5xl md:text-6xl flex text-slate-300 justify-center gap-3 my-1">
              <a
                className="fa-brands fa-square-twitter hover:scale-110 transition"
                href={`https://twitter.com/intent/tweet?text=${textShare}`}
                target="_blank"
              ></a>
              <a
                className="fa-brands fa-square-whatsapp hover:scale-110 transition"
                href={`https://wa.me/?text=${textShareWpp}`}
                target="_blank"
              ></a>
            </div>
            <div className="w-full flex flex-col items-center">
              ...
              <div className="flex justify-between md:justify-evenly gap-2">
                ...
                <Link
                  to={`http://melodymingler.vercel.app/album/${review.idAlbum}`}
                >
                  <Button color="gray">Seguir para o link</Button>
                </Link>
              </div>

              <div className="w-full flex items-center flex-col m-2 bg-slate-600 p-3 rounded-lg">
                <p className="text-center text-xl font-bold">
                  Baixar uma Imagem da sua Avaliação
                </p>
              ...
              <div
                ref={divRef}
                className={`hidden p-40 border-8 border-slate-800 items-center gap-2`}
              >
                <div className="w-full">
                  <p className="text-7xl text-center font-bold mb-10">
                    MelodyMingler
                  </p>
                  <div className="w-full flex justify-center items-center">
                    <img
                      className="w-[45rem] border-8 border-slate-700 rounded-xl"
                      src={review.InfoAlbum.images[0].url}
                    />
                  </div>
                  <p className="font-semibold text-7xl text-center">
                    {review.nameAlbum}
                  </p>
                  <p className="text-4xl text-center">
                    {review.InfoAlbum.artists[0].name}
                  </p>
                  ...
                  <p className={classNames("text-justify mt-3", review.avaliacao.lenght < 350 ? 'text-5xl' : 'text-4xl')}>
                    {review.avaliacao}
                  </p>
                </div>
              </div>
