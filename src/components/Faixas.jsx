    ...
    <div className="w-100">
      {
        faixas.map((msc, index)=>(
          <div key={index} className="flex justify-center items-center mt-5 gap-3 w-full px-5">
            <div className="flex w-full md:p-5 md:shadow-2xl md:border-2 border-neutral-700 md:bg-gradient-to-tl md:hover:bg-gradient-to-tr md:hover:from-neutral-900 md:hover:to-neutral-950 cursor-pointer from-neutral-800 to-neutral-900 justify-between items-center" key={index}>
